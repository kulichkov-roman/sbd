...
if ($RIGHT >= "R"){
    ...
    $aTabs      = Array(
        Array(
            ...
            "OPTIONS" => Array(
                // "vregions_site_url" => Array(GetMessage("VREGIONS_SITE_URL"), Array("text")), // todo ������������ ��� ����������
                ...
                // todo ����� ����� ������ ��� ���������� vregions_auto_geoposition
        ...
        Array(
            ...
            "OPTIONS" => Array(
                ...
                /*RBS_CUSTOM_START*/
                "vregions_add_string_to_meta_ignore"    => Array(
                    GetMessage("VREGIONS_ADD_STRING_TO_META_IGNORE"),
                    Array(
                        "textarea"
                    ),
                    "",
                    GetMessage("VREGIONS_ADD_STRING_TO_META_IGNORE__DESCR")
                ),
                /*RBS_CUSTOM_END*/
            )
        ),
    ...
    if ($REQUEST_METHOD == "POST" && strlen($Update.$Apply.$RestoreDefaults) > 0 && check_bitrix_sessid()){
        if (strlen($RestoreDefaults) > 0) // ���� ���� ������� "�� ���������", �� ���������� ��� option'�
