...
else
{
	if ($arParams['REFRESHED_COMPONENT_MODE'] === 'Y')
	{
		...
		<div class="bx-sap" id="bx-sap<?=$wrapperId?>">
			<div class="container-fluid">
				...
				if ($arParams['SELL_VALUES_FROM_VAR'] != 'Y')
				{
					if ($arParams['SELL_SHOW_FIXED_VALUES'] === 'Y')
					{
						...
						<div class="row">
							<div class="col-xs-12 sale-acountpay-block">
                                <div class="title-h3 sale-acountpay-title"><?= Loc::getMessage("SAP_FIXED_PAYMENT") ?></div>
					...
					<div class="row">
						<div class="col-xs-12 sale-acountpay-block form-horizontal">
                            <div class="title-h3 sale-acountpay-title"><?= Loc::getMessage("SAP_SUM") ?></div>
				...
				else
				{
					if ($arParams['SELL_SHOW_RESULT_SUM'] === 'Y')
					{
						...
						<div class="row">
							<div class="col-xs-12 sale-acountpay-block form-horizontal">
                                <div class="title-h3 sale-acountpay-title"><?= Loc::getMessage("SAP_SUM") ?></div>
								<div class="title-h2"><?=SaleFormatCurrency($arResult["SELL_VAR_PRICE_VALUE"], $arParams['SELL_CURRENCY'])?></div>
							</div>
						</div>
						<?
					}
				...
				<div class="row">
					<div class="col-xs-12 sale-acountpay-block">
                            <div class="title-h3 sale-acountpay-title"><?= Loc::getMessage("SAP_TYPE_PAYMENT_TITLE") ?></div>
						<div>
	...
	{
		?>
        <div class="title-h3"><?= Loc::getMessage("SAP_BUY_MONEY") ?></div>
