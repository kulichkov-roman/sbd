...
<div class="main-slider arrows-1 dots-1 dots-2 js-slider-1">
    <? foreach($arResult['ITEMS'] as $arItem):
        ...
        $file['src'] = CResizer2Resize::ResizeGD2($originalPath, $arParams['RESIZER_SET']);
        $fileJpg['src'] = CResizer2Resize::ResizeGD2($originalPath, 42);
        ...
        <article class="main-slider__item" data-lazy="<?=$file['src']?>" data-lazy-jpg="<?=$fileJpg['src']?>"  style="">
            ...
            <?endif?>
                    <div class="main-slider__content">
                        <p class="main-slider__title"><?=$arItem['PROPERTIES']['RBS_TITLE']['VALUE']?></p>
