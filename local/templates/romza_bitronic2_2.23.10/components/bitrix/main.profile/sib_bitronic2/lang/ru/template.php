...
$MESS ['LOGIN'] = "Изменить логин";
$MESS ['NEW_PASSWORD'] = "Изменить пароль";
$MESS ['NEW_PASSWORD_CONFIRM'] = "Повторите пароль";
...
$MESS ['EMAIL'] = "Изменить e-mail";
$MESS ['NAME'] = "Имя";
$MESS ['LAST_NAME'] = "Фамилия";
$MESS ['USER_BIRTHDAY_DT'] = "Дата рождения";
$MESS ['USER_PHOTO'] = "Ваша фотография";
$MESS ['USER_PHOTO_TITLE'] = "Фото пользователя (аватар)";
$MESS ['PERSONAL_PHONE'] = "Телефон";
$MESS ['CHOOSE_FILE'] = "Выберите файл";
$MESS ['NOT_CHOOSEN_FILE'] = "*Файл не выбран";
$MESS ['DELETE_FILE'] = "Удалить файл";

$MESS ['REQUIRED_DESCRIPTION'] = 'эти поля обязательны для заполнения';

$MESS ['REG_SHOW_HIDE'] = "Личные данные";
