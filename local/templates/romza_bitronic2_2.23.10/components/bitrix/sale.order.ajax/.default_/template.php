...
else
{
	...
	?>
<section class="main-block main-block_order">
	<div class="order">
        <h3 class="main-title">Оформление заказа</h3>
        <div class="order__cnt">
            <div class="order-step">   
				<div class="order-step__item active">
					<div class="order-step__heading">
						<div class="order-step__head"><span>1</span>Контактная информация</div>
						...
						<div class="contacts">
							<?if(!$USER->IsAuthorized()):?>
								<div class="warn">
									...
									<p><a href="#" class="warn__link">Авторизуйтесь</a> для отслеживания статуса заказа в "Личном кабинете", накопления бонусов и автоматического заполнения форм</p>
								</div>
							<?endif?>
							<div class="box-form">
								<form>
									...
									<div class="checkbox">
										<label><input class="js-formstyler" type="checkbox" checked>Я согласен на обработку моих персональных данных для оформления заказа</label>
									</div>  
									<div class="checkbox">
										<label><input class="js-formstyler" type="checkbox" checked>Подписаться на рассылку выгодных предложений</label>
									</div> 
									<button class="button button_white js-next-step" type="submit">Продолжить</button>                                                      
								</form>
							</div>
						</div>
					</div>
				...
				<div class="order-step__item">
					<div class="order-step__heading">                                    
						<div class="order-step__head"><span>2</span>Способ получения</div>
						<div class="order-step__icon"></div>    
						<a href="#" class="order-change js-order-change"><i class="icon-pencil"></i><span>Изменить</span></a>
					</div>
					...
					<div class="order-step__cont">
						<div class="order-delivery">
							<div class="order-delivery-town">Доставка в 
								<div class="city city_delivery js-click">
									<a class="city__selected js-click-button" href="javascript:void(0);"><span class="js-city-selected">Нижний Новгород</span></a>
								</div>
							</div>
							<div class="delivery-options arrows-2 js-delivery-options">
								<div class="delivery-options__item">
									<div class="delivery-options__cont js-delivery-choice">
										<div class="delivery-options__img">
											<img src="img/delivery-opt-1.jpg" alt="">
											<div class="delivery-options__logo"><img src="img/delivery-comp-1.png" alt=""></div>
										</div>
										<div class="delivery-options__text">
											<div class="delivery-options__title"><span>DPD</span> (online classic - до пункта выдачи со страховкой)</div>
								...
								<div class="delivery-options__item active">
									<div class="delivery-options__cont js-delivery-choice js-delivery-form">
										<div class="delivery-options__img">
											<img src="img/delivery-opt-2.jpg" alt="">
											<div class="delivery-options__logo"><img src="img/delivery-comp-1.png" alt=""></div>
										</div>
										<div class="delivery-options__text">
											<div class="delivery-options__title  delivery-options__title_min-h"><span>DPD</span> (online classic - курьером до двери)</div>
											<ul class="delivery-options-list">
												<li>1-3 дня</li>
												<li>Стоимость: <span>290 <span class="icon-rub"></span></span></li>
											</ul>
										</div>
									</div>
								</div> 
								<div class="delivery-options__item">
									<div class="delivery-options__cont js-delivery-choice">
										<div class="delivery-options__img">
											<img src="img/delivery-opt-3.jpg" alt="">
											<div class="delivery-options__logo"><img src="img/delivery-comp-2.png" alt=""></div>
										</div>
										<div class="delivery-options__text">
											<div class="delivery-options__title"><span>СДЭК</span> (посылка - до пункта выдачи со страховкой)</div>
											<ul class="delivery-options-list">
												<li>1-4 дня</li>
												<li>Стоимость: <span>310</span></li>
											</ul>
										</div>
									</div>
								</div> 
								<div class="delivery-options__item">
									<div class="delivery-options__cont js-delivery-choice js-delivery-form">
										<div class="delivery-options__img">
											<img src="img/delivery-opt-4.jpg" alt="">
											<div class="delivery-options__logo"><img src="img/delivery-comp-2.png" alt=""></div>
										</div>
										<div class="delivery-options__text">
											<div class="delivery-options__title"><span>СДЭК</span> (посылка - курьером до двери со страховкой)</div>
											<ul class="delivery-options-list">
												<li>1-4 дня</li>
												<li>Стоимость: <span>310</span></li>
											</ul>
								...
								<div class="delivery-options__item">
									<div class="delivery-options__cont js-delivery-choice">
										<div class="delivery-options__img">
											<img src="img/delivery-opt-5.jpg" alt="">
											<div class="delivery-options__logo"><img src="img/delivery-comp-3.png" alt=""></div>
										</div>
										<div class="delivery-options__text">
											<div class="delivery-options__title"><span>EMS Почта России </span> (со страховкой)</div>
											<ul class="delivery-options-list">
												<li>2-3 дня</li>
												<li>Стоимость: <span>310</span></li>
											</ul>
											<div class="delivery-options__warn">В небольших населенных пунктах доставка производится только до </div>
										</div>
									</div> 
								</div>                            
							</div>
							<div class="delivery-address" style="display: block;">
								<div class="delivery-address__title">Адрес доставки:</div>
									<form>
										<div class="address-form">
											<div class="address-form__col">
												<div class="address-form__label">улица / проспект / проезд...</div>
												<input type="text" class="input">
											</div>
											<div class="address-form__col">
												<div class="address-form__label">дом</div>
												<input type="text" class="input">
											</div>
											<div class="address-form__col">
												<div class="address-form__label">корпус</div>
												<input type="text" class="input">
											</div>
											<div class="address-form__col">
												<div class="address-form__label">строение</div>
												<input type="text" class="input">
											</div>
											<div class="address-form__col">
												<div class="address-form__label">литера</div>
												<input type="text" class="input">
											</div>
												<div class="address-form__col">
												<div class="address-form__label">квартира</div>
												<input type="text" class="input">
											</div>
												<div class="address-form__col">
												<div class="address-form__label">офис</div>
												<input type="text" class="input">
											</div>        
										</div>
									</form>
					...
					<div class="order-step__item">
						<div class="order-step__heading">                                    
							<div class="order-step__head"><span>3</span>Способ оплаты</div>
							<div class="order-step__icon"></div>    
						</div>
						...
						<div class="order-step__cont">
							<div class="payment-list arrows-2 js-payment-options">
								<div class="payment-list__item">
									<a href="#" class="js-payment-item payment-item">
										<div class="payment-item__img">
											<img src="img/payment-item-img-1.jpg" alt="alt">
										</div>
										<div class="payment-item__text">
											<h4>Наличными в магазине</h4>
											<p>Номер карты вы получите на указанный email после заказа. В комментариях к оплате укажите: Пополнение счета и «Номер Вашего заказа». <strong>Пример: Пополнение счета NF2T6Z</strong></p>
										</div>
									</a>
								</div>
								<div class="payment-list__item">
								<a href="#" class="js-payment-item payment-item">
									<div class="payment-item__img">
										<img src="img/payment-item-img-2.jpg" alt="alt">
									</div>
									<div class="payment-item__text">
										<h4>Наличными в магазине</h4>
										<p>Номер карты вы получите на указанный email после заказа. В комментариях к оплате укажите: Пополнение счета и «Номер Вашего заказа». <strong>Пример: Пополнение счета NF2T6Z</strong></p>
								...
								<a href="#" class="js-payment-item payment-item">
									<div class="payment-item__img">
										<img src="img/payment-item-img-3.jpg" alt="alt">
									</div>
									<div class="payment-item__text">
										<h4>Наличными в магазине</h4>
										<p>Номер карты вы получите на указанный email после заказа. В комментариях к оплате укажите: Пополнение счета и «Номер Вашего заказа». <strong>Пример: Пополнение счета NF2T6Z</strong></p>
								...
								<a href="#" class="js-payment-item payment-item">
									<div class="payment-item__img">
										<img src="img/payment-item-img-4.jpg" alt="alt">
									</div>
									<div class="payment-item__text">
										<h4>Наличными в магазине</h4>
										<p>Номер карты вы получите на указанный email после заказа. В комментариях к оплате укажите: Пополнение счета и «Номер Вашего заказа». <strong>Пример: Пополнение счета NF2T6Z</strong></p>
		...
		<div class="total total_order">
			...
			<ul class="order-list">
				<li class="order-list__item">
					OnePlus 5T 128Gb Красный <span>10 599</span>
				</li>
				<li class="order-list__item">
					OnePlus 5T 128Gb Черный <span>8 950</span>
				</li>
				<li class="order-list__item">
					OnePlus 5T 128Gb Золотой <span>5 455</span>
				</li>
				<li class="order-list__item">
					OnePlus 5T 128Gb Розовый <span>9 500</span>
				</li>
			</ul>
			<div class="total__delivery">
				<div class="total__heading">
					Выбранный способдоставки и оплаты
				</div>
				<p>Самовывоз, бесплатно —</p>
				<p>Оплата — <span>Оплата заказа в магазине</span></p>
			</div>
			<div class="total__info">
				<p>Скидка на сумму: <span>2 499</span></p>
				<p>Доставка: <span>0</span></p>
			</div>
			<div class="total__btm">
				<div class="total__sum">
					Итого: <span>5 499</span>
				</div>
			...
			<div class="comment-order-wrap">
				<a href="#" class="total__link">Комментарий к заказу</a>
				<textarea class="comment-order"></textarea>
			</div>                    
		</div>
	</div>
</section>
