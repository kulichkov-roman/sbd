...
$this->addExternalJs($templateFolder.'/scripts/edost.js');
...
else
{
	...
	<?endif?>
	<div class="rbs-soa-mask"></div>
	<h3 class="main-title"><?$APPLICATION->ShowTitle()?></h3>
<section class="main-block_order">
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="bx-soa">
				...
				<div class="rbs-order-header">
					<div class="rbs-order-header-step step-active current-step" data-section-bind="bx-soa-properties" data-next-section-bind="bx-soa-delivery">
						<span class="rbs-order-header-step-num">1</span>
						<span class="rbs-order-header-step-title rbs-show-desktop rbs-first-step-active">Информация о клиенте</span>
						<span class="rbs-order-header-step-title rbs-show-mobile">Покупатель</span>
					</div>
					<div class="rbs-order-header-step" data-section-bind="bx-soa-delivery" data-next-section-bind="bx-soa-paysystem" data-prev-section-bind="bx-soa-properties">
						<span class="rbs-order-header-step-num">2</span>
						<span class="rbs-order-header-step-title rbs-show-desktop">Способ получения</span>
						<span class="rbs-order-header-step-title rbs-show-mobile">Доставка</span>
					</div>
					<div class="rbs-order-header-step" data-section-bind="bx-soa-paysystem" data-prev-section-bind="bx-soa-delivery">
						<span class="rbs-order-header-step-num">3</span>
						<span class="rbs-order-header-step-title rbs-show-desktop">Способ оплаты</span>
						<span class="rbs-order-header-step-title rbs-show-mobile">Оплата</span>
					</div>
				</div>
			...
			<div id="bx-soa-total" class="bx-soa-sidebar">
				...
				<div class="bx-soa-cart-total total total_order">
