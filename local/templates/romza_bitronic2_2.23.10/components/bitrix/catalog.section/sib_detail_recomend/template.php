				...
				<div class="catalog-item__content">
					<div class="catalog-title">
						<div class="rec-item__img">
							<img itemprop="contentUrl" title="<?= $imgTitle ?>" src="<?=$arItem['PICTURE_PRINT']['SRC']?>" alt="<?=$arItem['PICTURE_PRINT']['ALT']?>">
						</div>
						<a class="catalog-title__link" href="<?=$arItem['DETAIL_PAGE_URL']?>" tabindex="0" data-ellipsis-id="25"><span><?=$arItem['NAME']?></span></a>
					</div>
					<?
