...
?><section class="main-block main-block_index">
        <div class="main-block__top">
            <div class="main-block__left">
                <p class="main-title"><?=$arParams['TAB_HEADER']?></p>
            </div>
            <div class="main-block__right">
                <a class="arrow-link" href="<?=$arParams['TAB_LINK']?>"><span><?=$arParams['TAB_ALL']?></span></a>
            </div>
        </div>
<div class="catalog rbs-hor-catalog">
...
<ul class="rbs-hor-catalog__list rbs-correct-old-price catalog__list catalog__list_1 js-slider-2 dots-1 arrows-2">
    <?foreach($arResult['ITEMS'] as $arItem):
        ...
        <li class="catalog-item" id="<?=$arItemIDs['ID']?>">
            ...
            /* if ($arParams['DISPLAY_FAVORITE'] === 'Y')
            { */
