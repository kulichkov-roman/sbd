...
<section class="main-block main-block_wait-serv">
    <div class="main-block__top">
        ...
        <div class="main-block__right">
            <a class="arrow-link" href="<?=$arParams['LINK_TO_ALL']?>"><span><?=$arParams['LINK_TO_ALL_TEXT']?></span></a>
        </div>
    </div>
    <div class="catalog catalog_services catalog_services-wait main-block_index">
        <ul class="catalog__list catalog__list_1 js-slider-2 dots-1 arrows-2">
            <?foreach($arResult['ITEMS'] as $arItem):
                ...
                <li class="catalog-item" id="<?=$arItemIDs['ID']?>">
                    ...
                    <a class="catalog-image" href="<?= $arItemIDs['DETAOL_PAGE_URL'] ?>">
                        <div class="catalog-image__fix">
                            <img alt="<?=$arItem['PICTURE_PRINT']['ALT']?>" class="lazy" data-original="<?=$arItem['PICTURE_PRINT']['SRC']?>" src="<?=ConsVar::showLoaderWithTemplatePath()?>">
                        </div>
                    </a>
                    <div class="catalog-item__content">
                        <h4 class="catalog-title">
                            <a class="catalog-title__link js-ellip-2" href="#"><span><?=$productTitle?></span></a>
                        </h4>
                        <div class="catalog-bottom">
                            <div class="catalog-bottom__left">
                                <p class="current-price" id="<?= $arItemIDs['PRICE'] ?>"><?=$arItem['MIN_PRICE']['DISCOUNT_VALUE']?></p>
                            </div>
