...
<div class="rbs-tab-wrapper" id="<?=$arParams['MAIN_BLOCK_ID'];?>">
    <div class="accessories">
        <ul class="accessories-nav_mob main-block_index">
            <?$cnt=0;?>
            <?foreach($arResult['ITEMS_SECTION']  as $sectionId => $section):?>
                <li class="accessories-nav__item">
                    <div class="accessories-nav__link js-accessories-nav__link">
                        <span class="accessories-nav__title"><?=$arResult['SECTIONS'][$sectionId]['NAME']?:$arParams['LINK_TO_ALL_TEXT']?></span>
                        <span class="accessories-nav__count"><?=count($section)?></span>
                    </div>
                    <div class="accessories-cont">
                       <!--  <div class="accessories-cont__title">
                            <div class="accessories-filter-mobile">
                                Сортировать по:
        ...
        <ul id="<?=$arParams['REPLACE_AJAX_ID']?>" class="catalog__list  js-mobile-tab-catalog dots-1 arrows-2 catalog__list_1">
                        ...
                        <div class="catalog-item__main" >
                            ...
                            <?endif;?>
                                <div class="catalog-image__fix">
                                    <img alt="<?=$arItem['PICTURE_PRINT']['ALT']?>" src="<?=SITE_TEMPLATE_PATH . '/img/placetransparent.png'?>" class="placeholder" data-lazy="<?=$arItem['PICTURE_PRINT']['SRC']?>" data-lazy-jpg="<?=$arItem['PICTURE_PRINT']['SRC_JPG']?>">
                                </div>
                            </a>
                            <?
