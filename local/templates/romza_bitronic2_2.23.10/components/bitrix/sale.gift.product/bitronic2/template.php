...
?>
<div class="viewed-products gift-slider<?= $bHoverMode ? ' __expanded' : '' ?>"   id="viewed-products-gift-slider">
...
(function($){
	...
	var $withGift = $stickerwrap.find('.with-gift');
	if ($withGift.length < 1) {
		$withGift = $('<div class="sticker with-gift flaticon-6"><?=GetMessage("BITRONIC2_GIFTS_MAIN_PRODUCT_TEXT")?></div>').hide();
		$withGift.appendTo($stickerwrap);
	}
	$withGift.slideDown();
})(jQuery);
</script>
