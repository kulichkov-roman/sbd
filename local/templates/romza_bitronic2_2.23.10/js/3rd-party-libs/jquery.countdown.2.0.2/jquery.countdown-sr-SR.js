...
(function($) {
	$.countdown.regionalOptions['sr-SR'] = {
		labels: ['Godina', 'Meseci', 'Nedelja', 'Dana', 'ДЊasova', 'Minuta', 'Sekundi'],
		labels1: ['Godina', 'Mesec', 'Nedelja', 'Dan', 'ДЊas', 'Minut', 'Sekunda'],
		labels2: ['Godine', 'Meseca', 'Nedelje', 'Dana', 'ДЊasa', 'Minuta', 'Sekunde'],
