...
//	
//	cette class etendue est open source, toute modification devra cependant etre repertoriйe~
...
class SVG {
	...
	var $svg_gradient;	//	array - contient les infos sur les gradient fill du svg classй par id du svg
	...
	var $svg_string;		//	String contenant le tracage du svg en lui mкme.
...
function Arcto($x1, $y1, $x2, $y2, $rx, $ry, $angle, $largeArcFlag, $sweepFlag) {
	...
	//	 le cercle est tracй grave a 4 bezier cubic, les poitn de controles
	...
	function ImageSVG($data){
		...
		if(!function_exists("xml_svg2pdf_start")){	// mPDF 5.3.76
			...
			function xml_svg2pdf_start($parser, $name, $attribs){
				...
				//
				//insertion des path et du style dans le flux de donnй general.
