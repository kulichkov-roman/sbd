...
<html>
<body onload="document.credit.submit()">
<? 
...
if ($HMAC_Generator->check_data_hmac($order, NULL, "sign_param_name") == 1):
 ?>
<form action="https://loans.tinkoff.ru/api/partners/v1/lightweight/create" method="post" name="credit">
<input name="shopId" value="sibdroid" type="hidden"/>
<input name="showcaseId" value="sibdroid" type="hidden"/>
